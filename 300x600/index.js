...
boilerplate.DynamicContentElements = function () {
	...
	Enabler.setProfileId(10133305);
    var devDynamicContent = {};

    devDynamicContent.CPACongressDynamicBanners2018_300x600= [{}];
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0]._id = 0;
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].unique_id = 2;
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].ad_name = "CPA-Congress1";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].frame1 = "option2";
    ...
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].logo.Type = "file";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].logo.Url = "https://s0.2mdn.net/ads/richmedia/studio/60006638/60006638_20180802165105694_logo.png";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].cta_button_text = "Find Out More";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].ctaTextColour = "#ffffff";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].cta_backgroundColor = "none";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].exitUrl = "";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_image = {};
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_image.Type = "file";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_image.Url = "https://s0.2mdn.net/ads/richmedia/studio/60006638/60006638_20180802165052096_background.png";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_transparent = "background: rgb(0,155,199);background: linear-gradient(35deg, rgba(0,155,199,1) 0%, rgba(255,255,255,0) 85%);";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_color = "#99a233";
    devDynamicContent.CPACongressDynamicBanners2018_300x600[0].isDefault = false;
	...
	f1_option = dynamicContent.CPACongressDynamicBanners2018_300x600[0].frame1;
	f2_option = dynamicContent.CPACongressDynamicBanners2018_300x600[0].frame2;
	f3_option = dynamicContent.CPACongressDynamicBanners2018_300x600[0].frame3;
	f4_option = dynamicContent.CPACongressDynamicBanners2018_300x600[0].frame4;
	...
	switch (f1_option) {
		...
		case 'option2':
			...
			frame1.classList.add('hide');
			frame1.innerHTML = content_formats[3];
			break;
	}
	...
	banner.style.cssText = "background-color:" + dynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_color + ";";
	bgImage.src = dynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_image.Url;
	trasparentBg.style.cssText = dynamicContent.CPACongressDynamicBanners2018_300x600[0].bg_transparent;
	logo.src = dynamicContent.CPACongressDynamicBanners2018_300x600[0].logo.Url;
	cta.innerHTML = dynamicContent.CPACongressDynamicBanners2018_300x600[0].cta_button_text;
	cta.style.cssText = "color:" + dynamicContent.CPACongressDynamicBanners2018_300x600[0].ctaTextColour + ";" + "background-color:" + dynamicContent.CPACongressDynamicBanners2018_300x600[0].cta_backgroundColor + ";";
	exitUrl = dynamicContent.CPACongressDynamicBanners2018_300x600[0].exitUrl;
	...
	var textSrcs = [
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f1_text,
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f2_text1,
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f2_text2,
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f2_text3,
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f3_text1,
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f3_text2,
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f3_text3,
		dynamicContent.CPACongressDynamicBanners2018_300x600[0].f4_text1,
